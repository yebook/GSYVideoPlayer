...
public class GSYModel {
    ...
    public GSYModel(String url, Map<String, String> mapHeadData, boolean loop, float speed, boolean isCache, File cachePath, String overrideExtension, float voiceNum) {
        this.url = url;
    ...
    public float getVoiceNum() {
        return voiceNum;
    }

    public void setVoiceNum(float voiceNum) {
        this.voiceNum = voiceNum;
    }
