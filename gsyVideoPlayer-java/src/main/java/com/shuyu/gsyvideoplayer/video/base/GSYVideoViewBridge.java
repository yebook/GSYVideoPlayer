...
public interface GSYVideoViewBridge {
     ...
     */
    void prepare(final String url, final Map<String, String> mapHeadData, boolean loop, String overrideExtension);
     ...
     * @param url 指定url缓存
     */
    boolean cachePreview(Context context, String url);
     ...
     * 播放速度修改
     */
    void setSpeed(boolean soundTouch);
     ...
     * @param soundTouch
     */
    void setSpeedPlaying(boolean soundTouch);
